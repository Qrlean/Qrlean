        ...
        <>
            <Modal titulo="Eliminar programa" state={modal} setState={setModal}>
                <div className="flex flex-col text-justify w-full h-full">
                    ...
                    <p className="text-red-400 text-base my-4 text-center">Si desactivas la asistencia no podrá ser firmada por ningún aprendiz.</p>
            ...
            <motion.div layoutId="item-expandible" className="bg-white rounded-lg w-full lg:w-4/5 h-85 m-3 overflow-x-hidden max-w-full flex flex-col justify-center items-center" style={{boxShadow:"rgba(0, 0, 0, 0.09) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px"}} >
                <div className='flex flex-row items-center h-full w-full  relative' >
                    ...
                    <motion.div className="flex flex-col justify-center items-end mx-2 sm:mx-16 h-full py-6 " initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.5}}>
                        <svg onClick={()=> router.push('/dashboard/instructor/fichas/[ficha]/[materia]/editar/[id]',`/dashboard/instructor/fichas/${router.query.ficha}/${router.query.materia}/editar/${3}`)} viewBox="0 0 16 16" className="cursor-pointer fill-current h-8 w-8 sm:h-12 sm:w-12 my-4 text-gray-800 " xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                        </svg>
                        <svg viewBox="0 0 16 16"  className="cursor-pointer fill-current h-8 w-8 sm:h-12 sm:w-12 my-4 text-gray-800 " xmlns="http://www.w3.org/2000/svg" onClick={()=>setModal(true)}>
                            <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                            <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer fill-current h-8 w-8 sm:h-12 sm:w-12 my-4 text-gray-800 " viewBox="0 0 16 16" onClick={()=> router.push('/dashboard/instructor/fichas/[ficha]/[materia]/firmar/[id]',`/dashboard/instructor/fichas/${router.query.ficha}/${router.query.materia}/firmar/${1}`)}>
