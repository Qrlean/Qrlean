...
const validationSchema = Yup.object().shape({
    ...
    password: Yup.string('El password debería solo contener caracteres alfanuméricos.')
...
const Login = () => {
    ...
    return (
        <div className="w-full h-screen " style={{backgroundImage: "url('https://cdn.pixabay.com/photo/2017/07/31/11/21/people-2557396_960_720.jpg')",backgroundSize: "cover",backgroundRepeat: "no-repeat" }}>
            <div className="w-full h-full bg-gray-800 bg-opacity-50 flex flex-col justify-center items-center">
                ...
                <form onSubmit={formik.handleSubmit} className="w-11/12 lg:w-1/3 xl:w-1/3 bg-white rounded-lg " style={{height:"95%"}}>
                    ...
                    <div className="flex flex-col justify-center w-10/12 mx-auto h-full overflow-y-scroll md:overflow-y-hidden ">
                        ...
                        <>
                            <Link href="/">
                                <svg  viewBox="0 0 20 20" fill="black" className="cursor-pointer h-12 w-12 lg:absolute lg:z-50 lg:left-0 lg:m-8  lg:top-0">
                            ...
                            <input type="text" placeholder="Ingrese un documento" name="documento" onChange={formik.handleChange}  value={formik.values.documento} className="outline-none bg-gray-300 p-3  text-gray-800 my-2 "/>
                            <AnimatePresence>
                            ...
                            <select name="tipo_doc" onChange={formik.handleChange} value={formik.values.tipo_doc} className="text-center outline-none bg-gray-300 p-2  text-gray-800 my-2 ">
                            ...
                            <AnimatePresence>
                                {formik.errors.password && formik.touched.password ? <motion.p initial="initial" animate="animate" exit="unshow" variants={errorVariants} className="rounded-lg overflow-hidden text-center text-red-600 text-base">{formik.errors.password}</motion.p>:null}
                            </AnimatePresence>
