...
const Ficha = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-4 h-full relative overflow-y-auto">
            <svg  viewBox="0 0 20 20" fill="black" className="cursor-pointer   top-0 left-0 absolute  w-10 h-10 fill-current text-gray-800 m-4" onClick={()=>router.push('/dashboard/admin/fichas')} style={{zIndex:999}}>
            ...
            <svg onClick={()=> router.push('/dashboard/admin/fichas/[ficha]/asociar',`/dashboard/admin/fichas/${router.query.ficha}/asociar`)} xmlns="http://www.w3.org/2000/svg" className="cursor-pointer fill-current text-gray-800 absolute right-0 top-0 m-4 h-10 w-10" viewBox="0 0 16 16">
            ...
            <div className="flex flex-row justify-center items-center w-11/12 md:w-full h-full flex-wrap">
                ...
                <div className="w-full mb-1 rounded-lg shadow-lg" style={{border: "1px solid rgba(31, 41, 55,1)",height:"49%"}}>
                    <ResponsivePie
                ...
                <div className="w-full mt-1 rounded-lg shadow-lg" style={{border: "1px solid rgba(31, 41, 55,1)",height:"49%"}}>
                    <ResponsivePie
                        margin={{top:40,bottom:40}}
                        data={data}
                        innerRadius={0.5}
            ...
            <div className="my-12 w-full h-auto">
                <h1 className="text-center text-3xl text-gray-800 mx-auto my-4">Materias</h1>
                {['Ingles','Matematicas','Español'].map((value)=>
                <ItemMaterias titulo={`${value}`} width="w-11/12" clases={['1.Programacion','2.Diagramas']}></ItemMaterias>
                )}
            </div>
            <div className="flex flex-col justify-center items-center w-11/12 ">
                <h1 className="text-center text-3xl mx-auto my-4 w-auto border-red-500 text-gray-800 p-3 rounded shadow border-t-2">Aprendices en estado critico.</h1>
                <div className="flex flex-row items-center justify-center flex-wrap w-full">
                {[1,2,3,4,5].map(()=><ItemPersonaAsistencia></ItemPersonaAsistencia>)}
                </div>
            </div>
