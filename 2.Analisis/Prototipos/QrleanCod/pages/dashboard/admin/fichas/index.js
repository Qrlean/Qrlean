...
import Item from '../../../../components/layout/fichas/Item'
...
const Fichas = () => {
    ...
    const fichas = [
        {_id:1,numero:'2141041',personas:['1','2','3'],programa:'123123123 Programacion'},
        {_id:2,numero:'2141041',personas:['1','2','3'],programa:'123123123 Programacion'},
        {_id:3,numero:'2141041',personas:['1','2','3'],programa:'123123123 Programacion'},
    ];
    const error = false;
    const loader = false;
            ...
            <Dashboard>
                ...
                <div className="h-2/12 relative w-full bg-gray-300 shadow-lg flex flex-row justify-center items-center">
                    ...
                    <div className="flex-1 h-8/12 flex flex-row justify-end xl:mx-28 mx-4 rounded">
                        ...
                        <button onClick={()=> router.push('/dashboard/admin/fichas/crear')} className="outline-none bg-orange-300 rounded-lg text-xl text-gray-800 px-2 shadow-lg">Nueva ficha.</button>
                ...
                <div className="h-10/12 w-full overflow-x-hidden bg-gray-300 flex justify-center items-center flex-row flex-wrap relative">
                    {
                        ...
                        :
                            ...
                            <>
                                ...
                                <h1 className="w-full text-gray-800 text-3xl font-semibold lg:text-4xl text-center my-8">Fichas</h1>

                                {fichas.map((i)=>(<Item data={i} key={i._id} itemActivo={item} setItem={setItem}/>))}
