...
const validationSchema = Yup.object().shape({
    nombre: Yup.string()
        .matches(
            ...
            'El nombre debería solo contener caracteres alfanuméricos.',
        )
        ...
        <Dashboard>
            <div className="h-full w-full overflow-y-scroll bg-gray-300 flex flex-col py-6">
                ...
                >
                    ...
                    <AnimatePresence>
                        {formik.errors.dia && formik.touched.dia ? (
                            <motion.p
                                initial="initial"
                                animate="animate"
                                exit="unshow"
                    ...
                    <AnimatePresence>
                        {formik.errors.hora_inicio &&
                        formik.touched.hora_inicio ? (
                            <motion.p
                                initial="initial"
                                animate="animate"
                                exit="unshow"
                    ...
                    <div className="w-11/12 mx-auto mb-4">
                        <DatePicker
                            onChange={(e) =>
                                formik.setValues({
                                    ...formik.values,
                                    hora_inicio: Dateformat(e, 'hh:mm tt'),
                                })
                            }
                    ...
                    <AnimatePresence>
                        {formik.errors.hora_final &&
                        formik.touched.hora_final ? (
                            <motion.p
                                initial="initial"
                                animate="animate"
                                exit="unshow"
                    ...
                    <div className="w-11/12 mx-auto mb-4">
                        <DatePicker
                            onChange={(e) =>
                                formik.setValues({
                                    ...formik.values,
                                    hora_final: Dateformat(e, 'hh:mm tt'),
                                })
                            }
