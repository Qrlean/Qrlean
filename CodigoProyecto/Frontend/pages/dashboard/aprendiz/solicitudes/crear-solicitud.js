...
const validationSchema = Yup.object().shape({
    ...
    asunto: Yup.string(
        'El asunto debería solo contener caracteres alfanuméricos.',
    )
        ...
        <Dashboard>
            <div className="h-full w-full overflow-y-scroll bg-gray-300 flex flex-col py-6">
                <form
                    ...
                    className="flex flex-col justify-center w-full lg:w-3/6 mx-auto rounded relative shadow-xl bg-white border-t-4 border-orange-600"
                    autoComplete="off"
                >
                    ...
                    >
                        ...
                        <option value="1001277963" selected>
                            Instructor Camilo García
                        </option>
                    </select>
                    ...
                    <button
                        className={
                            formik.isValid &&
                            formik.values.asunto !== '' &&
                            formik.values.contenido !== '' &&
