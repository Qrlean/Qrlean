...
const SolicitudesAprendiz = () => {
    const solicitudes = [
        {_id:1,ficha:12341234,asunto:'prueba',receptor:'Julio Paparazi',contenido:'Tube una falla de internet el lunes'},
        {_id:2,ficha:12341234,asunto:'prueba',receptor:'Julio Paparazi',contenido:'Tube una falla de internet el lunes'},
        {_id:3,ficha:12341234,asunto:'prueba',receptor:'Julio Paparazi',contenido:'Tube una falla de internet el lunes'},
        {_id:4,ficha:12341234,asunto:'prueba',receptor:'Julio Paparazi',contenido:'Tube una falla de internet el lunes'},
    ];
    ...
    return (
        ...
        <div className="h-2/12 relative w-full bg-gray-300 shadow-lg flex flex-row justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>router.push('/dashboard/aprendiz')} className="xl:ml-28 ml-4 h-8/12  fill-current text-gray-800" viewBox="0 0 16 16">
            ...
            <div className="flex-1 h-8/12 flex flex-row justify-end xl:mx-28 mx-4 rounded">
                ...
                <button onClick={()=> router.push('/dashboard/aprendiz/solicitudes/crear-solicitud')} className="outline-none bg-orange-300 rounded-lg text-xl text-gray-800 px-2 shadow-lg">Nueva solicitud.</button>
        ...
        <div className="h-10/12 w-full overflow-x-hidden bg-gray-300 flex justify-center items-center flex-row flex-wrap relative">
            {
                ...
                :
                    ...
                    <>
                        ...
                        <h1 className="w-full text-gray-800 text-3xl font-semibold lg:text-4xl text-center my-8">Tus solicitudes</h1>

                        {solicitudes.map((i)=>(<Item data={i} key={i._id} itemActivo={item} setItem={setItem}/>))}
