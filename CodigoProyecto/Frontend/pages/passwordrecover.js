    ...
    return (
        <div className="bg-gray-100 h-full overflow-x-hidden min-h-screen">
            ...
            >
                ...
                <input
                    type="text"
                    className="outline-none p-2 text-center my-4 text-xl text-gray-800 ring-2 ring-orange-400 w-80 rounded shadow-lg"
                />
                <button className="bg-orange-400 m-4  p-2 outline-none text-gray-800 text-xl  w-80 rounded shadow-lg">
                    Enviar correo.
                </button>
            </form>
        </div>
