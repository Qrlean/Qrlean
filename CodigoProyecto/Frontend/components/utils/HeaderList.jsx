...
const HeaderList = ({ setHeaderOptions }) => {
    return (
        <motion.div
            ...
            exit="exit"
            variants={variants}
            className="flex flex-col justify-center items-center fixed w-full h-screen bg-gray-800 z-50 overflow-x-hidden"
        >
            <svg
                viewBox="0 0 20 20"
                className="h-16 w-16"
            ...
            >
                <Link href="/">
                    <motion.h3
                        ...
                        className="text-white text-3xl font-semibold mx-5 cursor-pointer"
                    >
                        Inicio
                    </motion.h3>
                </Link>
