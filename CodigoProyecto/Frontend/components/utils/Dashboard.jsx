                        ...
                        <div className="flex flex-col justify-center items-center flex-1">
                                ...
                                <AnimatePresence>
                                    {opc ? (
                                        ...
                                        >
                                            <Link
                                                href="/"
                                                className="flex flex-row items-center m-1 mx-auto p-1"
                                            >
                            ...
                            <div className="w-full flex flex-col items-center">
                                <div className="flex flex-col justify-center h-full">
                                    <Link
                                        className="flex flex-row items-center rounded-lg cursor-pointe"
                                        href={`/dashboard/${user}`}
                                    >
                                        <div>
                                            <svg
                                            ...
                                            <motion.h1 className="text-center mx-auto  text-base font-semibold">
                                                Inicio
                                            </motion.h1>
                                        </div>
                                    </Link>
