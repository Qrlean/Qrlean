...
const ItemMaterias = ({ titulo, width, clases }) => {
    ...
    return (
        <motion.div className={`${width} mx-auto my-3 `}>
            <div
                className="cursor-pointer h-16 flex flex-row relative justify-center items-center w-full bg-orange-300 shadow border-orange-600 border-t-2 rounded text-gray-800 p-2 text-xl"
