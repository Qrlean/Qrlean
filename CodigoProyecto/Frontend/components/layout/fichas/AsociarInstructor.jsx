...
const validationSchema = Yup.object().shape({
    ...
    materia_id: Yup.string()
        .matches(
            /^\d+$/,
            'El id de la materia debería solo contener caracteres numéricos.',
        )
    ...
    return (
        ...
        >
            <motion.svg
                ...
                viewBox="0 0 16 16"
                className="cursor-pointer shadow-xl bg-orange-300 rounded top-0 right-0 absolute  w-10 h-10 fill-current text-gray-800 m-4"
            ...
            <svg
                ...
                onClick={() => props.setAsociarRol(null)}
            >
            ...
            <AnimatePresence>
                {formik.errors.instructor_id && formik.touched.instructor_id ? (
                    <motion.p
                        initial="initial"
                        animate="animate"
                        exit="unshow"
            ...
            <AnimatePresence>
                {formik.errors.materia_id && formik.touched.materia_id ? (
                    <motion.p
                        initial="initial"
                        animate="animate"
                        exit="unshow"
