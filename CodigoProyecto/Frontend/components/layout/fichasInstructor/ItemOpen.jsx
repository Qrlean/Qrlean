    ...
    return (
        <>
            <motion.div
                ...
                className="bg-white border-orange-500 border-t-4 rounded-lg w-full lg:w-4/5 h-85 m-3 overflow-x-hidden max-w-full flex flex-col justify-center items-center"
                style={{
                    boxShadow:
            ...
            >
                <div className="flex flex-row items-center h-full w-full  relative">
                    ...
                    >
                        <motion.h1
                            layoutId="ficha"
                            className="capitalize text-base md:text-2xl text-center font-semibold text-gray-800"
                        >
                            Ficha: {data.ficha}
                        </motion.h1>
                    </motion.div>
                    ...
                    >
                        <svg
                            ...
                            onClick={() =>
                                router.push(
                                    '/dashboard/instructor/fichas/1234/',
                                )
                            }
                        >
                            <path
