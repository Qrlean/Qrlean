        ...
        <>
            <Modal titulo="Eliminar programa" state={modal} setState={setModal}>
                <div className="flex flex-col text-justify w-full h-full">
                    ...
                    <p className="text-red-400 text-base my-4 text-center">
                        Si desactivas la asistencia no podrá ser firmada por
                        ningún aprendiz.
                    </p>
            ...
            >
                <div className="flex flex-row items-center h-full w-full  relative">
                    ...
                    <motion.div
                        layoutId="contenido"
                        className="flex flex-col justify-center items-center mx-2 sm:mx-16 h-full py-6 flex-1 w-full"
                    >
                        <motion.h1
                            layoutId="titulo"
                        ...
                        <motion.h2
                            layoutId="fecha"
                            className="text-xs md:text-base text-center text-gray-800"
                        >
                            Fecha:{data.fecha}
                        </motion.h2>
                        <motion.h2
                            layoutId="hora_inicio"
                            className="text-xs md:text-base text-center text-gray-800"
                        >
                    ...
                    >
                        <svg
                            onClick={() =>
                                router.push(
                                    '/dashboard/instructor/fichas/[ficha]/[materia]/editar/[id]',
                                    `/dashboard/instructor/fichas/${
                                        router.query.ficha
                                    }/${router.query.materia}/editar/${3}`,
                                )
                            }
                            viewBox="0 0 16 16"
                            className="cursor-pointer fill-current h-8 w-8 sm:h-12 sm:w-12 my-4 text-gray-800 "
                            xmlns="http://www.w3.org/2000/svg"
                        >
                        ...
                        <svg
                            ...
                            onClick={() =>
                                router.push(
                                    '/dashboard/instructor/fichas/[ficha]/[materia]/firmar/[id]',
                                    `/dashboard/instructor/fichas/${
                                        router.query.ficha
                                    }/${router.query.materia}/firmar/${1}`,
                                )
                            }
                        >
                            <path
